# <p align="center">🧠 Sylvex | AI-Powered Exam Intelligence</p>

<p align="center">
  <img src="https://img.shields.io/badge/Architecture-Modular-blueviolet?style=for-the-badge" alt="Architecture">
  <img src="https://img.shields.io/badge/Design-Glassmorphism-cyan?style=for-the-badge" alt="Design">
  <img src="https://img.shields.io/badge/AI-Neural_Synthesis-rose?style=for-the-badge" alt="AI">
  <img src="https://img.shields.io/badge/Voice-STT_/_TTS-green?style=for-the-badge" alt="Voice">
</p>
...
```mermaid
graph TD
    A[Global Drag & Drop] -->|PDF Stream| B[Sylvex Core Engine]
    B -->|Initialization| C[Neural Pattern Synthesis]
    C -->|State Hydration| D[Intelligence Dashboard]
    
    subgraph "The Intelligence Hub"
    D -->|Frequency Mapping| E[Dynamic Charting]
    D -->|Yield Analysis| F[High-Yield Rankings]
    D -->|Historical Density| G[Pattern Heatmaps]
    end
    
    F -->|Constraint Mapping| H[Smart Study Planner]
    H -->|Execution| I[Pomodoro Focus Engine]
    
    J[AI Voice Assistant] <-->|Bidirectional| B
    J <-->|Contextual Retrieval| D
```
